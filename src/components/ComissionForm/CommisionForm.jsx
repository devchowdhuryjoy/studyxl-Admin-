...
//       const url = `https://stdxl.globalrouteway.com/api/admin/agent/${selectedAgentId}/all-aplication`;
//       const token = getAuthToken();
...
//     const apiUrl = "https://stdxl.globalrouteway.com/api/admin/transactions";
