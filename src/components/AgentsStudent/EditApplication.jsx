...
//         { name: "student_profile_nationality", label: "Nationality", type: "text" },
...
//         { name: "field_of_study_name", label: "Field of Study", type: "text" },
//         { name: "subject", label: "Subject", type: "text" },
//         { name: "specialization", label: "Specialization", type: "text" },
//         { name: "duration", label: "Duration", type: "text" },
//         { name: "program_description", label: "Program Description", type: "textarea", rows: 3 },
//         { name: "program_summary", label: "Program Summary", type: "textarea", rows: 3 },
...
//         { name: "average_undergraduate_program", label: "Average UG Program", type: "number", step: "0.01" },
...
//         { name: "academic_qualifications", label: "Academic Qualifications (JSON)", type: "textarea", rows: 4 },
//         { name: "work_experiences", label: "Work Experiences (JSON)", type: "textarea", rows: 4 },
//         { name: "references", label: "References (JSON)", type: "textarea", rows: 4 },
//         { name: "test_scores", label: "Test Scores (JSON)", type: "textarea", rows: 4 }
//       ]
//     }
//   ];
